...
| `/tools/knowledge-center` | `tools/knowledge_center_content.html` | `tools_kc_content` | `initKnowledgeCenterContentPage` | User |
...
| **`global`** | `/admin/customers`, `/admin/users`, `/admin/roles`, `/admin/keys`, `/tools/knowledge-center` | Kein Mandanten-Bezug; Wechsel nur Session (optional), **keine Auswirkung** auf Seiteninhalt; Hinweis „Gilt nicht für diese Seite“ |
