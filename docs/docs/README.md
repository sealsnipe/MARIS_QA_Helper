...
Deploy & Updates: [`docs/DEPLOY.md`](../DEPLOY.md)
...
3. wählt **Docker oder lokal** (setzt `QDRANT_URL`)
4. fragt den **OpenAI API-Key für Embeddings**
5. lässt **Chat-Auth wählen** (API-Key oder OAuth mit Browser-Login)
6. startet optional den passenden **Docker-Stack** (inkl. Prod-/OAuth-Overlay)
...
Ausführliches Runbook: [`docs/11_setup_and_operations.md`](../11_setup_and_operations.md)  
Implementierungsplan: [`docs/09_implementation_plan.md`](../09_implementation_plan.md)
